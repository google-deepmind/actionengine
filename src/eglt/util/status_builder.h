#ifndef EGLT_UTIL_STATUS_BUILDER_H_
#define EGLT_UTIL_STATUS_BUILDER_H_
...
class ABSL_MUST_USE_RESULT StatusBuilder {
 public:
  ...
  // occurs.  A typical user will call this with `EGLT_LOC`.
  ...
  // enabled, it will use `location` as the location from which the log message
  // occurs.  A typical user will call this with `EGLT_LOC`.
  StatusBuilder(absl::StatusCode code, eglt::util::source_location location)
 ...
 private:
  struct Impl {
    ...
    Impl(const absl::Status& status, eglt::util::source_location location);
    Impl(absl::Status&& status, eglt::util::source_location location);
    Impl(const Impl&);
...
inline StatusBuilder UnknownErrorBuilder(eglt::util::source_location location) {
  return StatusBuilder(absl::StatusCode::kUnknown, location);
}

}  // namespace eglt::util

#endif  // EGLT_REDIS_STATUS_BUILDER_H_