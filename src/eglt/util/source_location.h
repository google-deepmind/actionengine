#ifndef EGLT_UTIL_SOURCE_LOCATION_H_
#define EGLT_UTIL_SOURCE_LOCATION_H_
...
class source_location {
 public:
  ...
  // used by the EGLT_LOC macro, hence the name.
...
#define EGLT_LOC \
  eglt::util::source_location::DoNotInvokeDirectly(__LINE__, __FILE__)

#endif  // EGLT_UTIL_SOURCE_LOCATION_H_