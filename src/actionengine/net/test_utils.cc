...
#include "actionengine/net/testing_utils.h"
...
TEST(PairableInMemoryStreamTest, SendsAndReceivesMessages) {
  act::testing::PairableInMemoryStream stream1("stream1");
  act::testing::PairableInMemoryStream stream2("stream2");
